...
void DoAtStart(){
 ...
 SetTrackedAnalog(true,true,true,true,true,true);
}
...
void ButtonChange0(bool value) {if(onOffSwitch){Serial.println("cda");PressNumpadNumber(8, value); }}
void ButtonChange1(bool value) {if(onOffSwitch){Serial.println("cdb");PressNumpadNumber(4, value);}}
void ButtonChange2(bool value) {if(onOffSwitch){Serial.println("cdc");PressNumpadNumber(2, value);}}
void ButtonChange3(bool value) {if(onOffSwitch){Serial.println("cdd");PressNumpadNumber(1, value);}}
void ButtonChange4(bool value) {if(onOffSwitch){Serial.println("cde");PressNumpadNumber(6, value);}}
void ButtonChange5(bool value) {if(onOffSwitch){Serial.println("cdf");PressNumpadNumber(0, value);}}
void ButtonChange6(bool value) {if(onOffSwitch){Serial.println("cdg");}}
void ButtonChange7(bool value) {if(onOffSwitch){Serial.println("cdh");PressNumpadNumber(0, value);}}
void ButtonChange8(bool value) {if(onOffSwitch){Serial.println("cdp");}}
void ButtonChange9(bool value) {if(onOffSwitch){Serial.println("cdo");PressNumpadNumber(4, value);}}
void ButtonChange10(bool value){onOffSwitch= value;}

void ButtonStay0(bool value) {}
void ButtonStay1(bool value) {}
void ButtonStay2(bool value) {}
void ButtonStay3(bool value) {}
void ButtonStay4(bool value) {}
void ButtonStay5(bool value) {}
void ButtonStay6(bool value) {if( value){Mouse.begin();Mouse.click();Mouse.end();Serial.println("ddd");}}
...
//*/
 ...
 void SetTrackedAnalog(bool p0,bool p1,bool p2,bool p3,bool p4,bool p5){
    analogTrackedPins[0]= p0;
    analogTrackedPins[1]= p1;
    analogTrackedPins[2]= p2;
    analogTrackedPins[3]= p3;
    analogTrackedPins[4]= p4;
    analogTrackedPins[5]= p5;
  }
